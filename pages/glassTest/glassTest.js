...
Page({
  ...
  data: {
    ...
    biasValue: [0, 0],
    url: [
      "{{app.globalData.address}}/img/rule_1.png",
      "{{app.globalData.address}}/img/rule.png",
      "{{app.globalData.address}}/img/red.png",
      "{{app.globalData.address}}/img/_red.png",
      "{{app.globalData.address}}/img/_yellow.png",
    ],
    tempFilePaths: ["", ""],
